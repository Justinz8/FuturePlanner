...
function App() {
  ...
  useEffect(() => {
    const LSCourseCards = localStorage.getItem('CourseCards-UTSC')
    const LSNmbTimeTableCards = localStorage.getItem('nmbTimeTableCards-UTSC')
    const LSNmbCourseCards = localStorage.getItem('nmbCourseCards-UTSC')
    const LSTimeTableName = localStorage.getItem('TimeTableName-UTSC')
    if (LSCourseCards) {
  ...
  useEffect(() => {
    localStorage.setItem('CourseCards-UTSC', JSON.stringify(CourseCards))
  }, [CourseCards])

  useEffect(() => {
    localStorage.setItem('nmbTimeTableCards-UTSC', JSON.stringify(nmbTimeTableCards))
  }, [nmbTimeTableCards])

  useEffect(() => {
    localStorage.setItem('nmbCourseCards-UTSC', JSON.stringify(nmbCourseCards))
  }, [nmbCourseCards])

  useEffect(() => {
    localStorage.setItem('TimeTableName-UTSC', JSON.stringify(TimeTableName))
  }, [TimeTableName])
